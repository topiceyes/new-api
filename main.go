...
func main() {
	...
	// 安全审计旁路:relay/common 不能反向 import service,这里显式注入实现。
	relaycommon.OnRelayInfoReady = audit.InspectRequest
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		// Neutral wire response: panic details stay in the server log; the
		// client gets no internal error text or project links.
	...
	server.Use(middleware.IPAccessControl())
