...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.UserRequestRateLimit())
	{
	...
	geminiRouter.Use(middleware.UserRequestRateLimit())
	{
	...
	geminiCompatibleRouter.Use(middleware.UserRequestRateLimit())
	{
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.UserRequestRateLimit(), middleware.Distribute())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.UserRequestRateLimit(), middleware.Distribute())
	{
